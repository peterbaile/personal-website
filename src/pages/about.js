    ...
    <>
      ...
      <div className="container-fluid h-100">
        <div className="row h-100">
          ...
          <div className="col-md-9 body-content" style={{ marginTop: '5em', marginBottom: '2em', padding: '0em 3em' }}>
            ...
            <p className="text-justify" dangerouslySetInnerHTML={{ __html: content }} style={{ marginBottom: '2em' }} />
